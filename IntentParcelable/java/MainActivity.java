    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_with_data_activity:
                ...
                MoveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Ramdan Rohendi");
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Ramdan Rohendi");
                mPerson.setAge(17);
                mPerson.setEmail("ramdanrohendi@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "083822062034";
